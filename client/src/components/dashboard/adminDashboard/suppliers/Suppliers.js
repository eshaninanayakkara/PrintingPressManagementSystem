...
const Suppliers = () => {
  // State for holding the list of suppliers
  const [supplier, setSupplier] = useState([]);
  // State for holding the search query entered
  ...
  const handleDelete = (id) => {
    axios
      ...
      .catch((err) => console.log(err)); // Log any errors that occur during deletion
  };

  // Function to export filtered supplier data to Excel
  const exportToExcel = () => {
    // Map through the list of suppliers to format data for export
