...
const UpdateOrder = () => {
  // State variables to manage form inputs and selected supplier
  ...
  // Effect to fetch order details from the server based on the ID
  useEffect(() => {
    axios
      ...
      .then((result) => {
        ...
        // Set state variables with fetched order details
  ...
  // Effect to fetch supplier data from the server
  useEffect(() => {
    axios
  ...
  // Effect to calculate total amount based on quantity and unit price
  useEffect(() => {
